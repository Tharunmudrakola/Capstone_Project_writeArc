...
export const ghostBtn = "text-[#0066cc] font-semibold hover:text-[#004499] transition-colors cursor-pointer text-sm";
...
export const inputClass =
  "w-full bg-white border border-[#d2d2d7] m-1.5 rounded-xl px-4 py-2.5 text-[#1d1d1f] text-sm placeholder:text-[#a1a1a6] focus:outline-none focus:border-[#0066cc] focus:ring-2 focus:ring-[#0066cc]/10 transition";
export const formGroup = "mb-4";
export const submitBtn =
  "w-full bg-[#0066cc] text-white font-semibold py-2.5 rounded-full hover:bg-[#004499] transition-colors cursor-pointer mt-5 text-sm tracking-tight";
...
export const articleContent =
  "text-[#1d1d1f] leading-[1.9] text-[1rem] whitespace-pre-line mt-8 break-all overflow-hidden";
...
// ─── Divider ──────────────────────────────────────────
export const divider = "border-t border-[#e8e8ed] my-3";
